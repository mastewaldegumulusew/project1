...
function LandingPage() {
    return (
        <div>
            ...
            <div className='mt-20'>
                <Div img={chat} headingText="Instant Realtime chat." 
                text='Sending message in realtime to friends and family from all over the world.' />
            ...
            <div className='flex justify-center items-center mb-8'>
                <button className='bg-registe text-gray-600 px-4 py-2 rounded-lg font-bold drop-shadow-2xl active:scale-75 duration-300'>
