        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, this.create({ email: email, password: password, userName: userName, displayPicture: displayPicture })];
                case 3:
                    user = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, this.findOne({ $or: [{ email: email }, { userName: userName }] })];
                case 1:
                    user = _a.sent();
                    if (!user) {
